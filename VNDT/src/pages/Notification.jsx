...
const sampleNotifications = [
  ...
  },
  {
    ...
    type: "warning",
    message:
      "Sản phẩm 'Loa Bluetooth JBL Charge 5' sắp hết hàng (còn 10 chiếc)",
  ...
  },
  {
    ...
    type: "warning",
    message:
      "Sản phẩm '	Smartwatch Samsung Galaxy Watch 5' sắp hết (còn 15 chiếc)",
          ...
          {showFilterMenu && (
            <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border z-10">
              <div className="p-2">
                ...
                >
                  <AlertTriangle size={16} className="text-yellow-500" /> Cảnh
                  báo
                </button>
                <button
                  onClick={() => {
                ...
                >
                  <CheckCircle size={16} className="text-green-500" /> Thành
                  công
                </button>
                <button
                  onClick={() => {
      ...
      {filteredNotifications.length === 0 ? (
        ...
        <div className="space-y-4">
          {filteredNotifications.map((n) => (
            <div
              key={n.id}
              className={`flex items-start justify-between ${getNotificationBg(
                n.type,
                n.read
      ...
      <div className="mt-8 p-4 bg-white rounded-lg shadow-md">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <button
            onClick={() =>
              addNotification(
                "Sao lưu dữ liệu tự động hoàn tất",
                "success",
                "system",
                generateUniqueId("system")
              )
